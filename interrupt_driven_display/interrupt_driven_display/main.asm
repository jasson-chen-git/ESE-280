;***************************************************************************
;*
;* Title: interrupt_driven_display.asm
;* Author: Jason Chen
;* Version: 1
...
;*			is connected to PORTE. If the flag is set, the contents of the array
...
;*			for each digit in bcd_entries display are written into led_display.
;*
;*			Note: entry of a non-BCD value is ignored and the program is entirely
;*			interrupt driven, main loop does not call any subroutines.
;*
...
.equ PERIOD = 1		; 38 for 2.5ms multiplex delay, 1 for 0.128ms
